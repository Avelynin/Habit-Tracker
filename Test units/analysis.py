...
def list_of_tracked_habits(current_user_id, conn):  # list of tracked habits
    cursor = conn.cursor()
...
def list_of_habits_with_the_same_periodicity(current_user_id, conn):  # list of tracked habits with this same periodicity
    cursor = conn.cursor()
...
def longest_run_streak_of_all_defined_habits(current_user_id, conn):  # longest run streak of all habits
    cursor = conn.cursor()
...
def longest_run_streak_of_chosen_habit(current_user_id, conn):  # longest run streak of chosen habit
    cursor = conn.cursor()
